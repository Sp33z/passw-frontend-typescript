  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide className="flex! flex-col! items-center! justify-start gap-4">
          ...
          <div className="w-full h-full flex flex-col items-center justify-center gap-8">
            <div className="relative w-40 h-40 flex items-center justify-center border-2 border-dashed rounded-full bg-(--text)/5">
              <LuUser className="w-auto h-3/10" />
              <button className="absolute bg-(--accent) bottom-0 right-0 w-12 h-12 border-6 border-(--background) flex flex-col items-center justify-center rounded-full">
                <MdOutlineCameraAlt className="w-auto h-6" />
              </button>
            </div>
            <Input className="w-9/10 h-fit bg-(--background) shadow rounded-xl p-3" placeholder="Hi, my name is..." />
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex! flex-col! items-center! justify-start gap-4">
          ...
          <div className="w-full h-full flex flex-col items-center justify-center gap-8">
            <Input className="w-9/10 h-fit bg-(--background) shadow rounded-xl p-3" placeholder="Password" Icon={PiPassword} type="password" />
            <Input className="w-9/10 h-fit bg-(--background) shadow rounded-xl p-3" placeholder="Password Again" Icon={PiPassword} type="password" />
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide className="flex! flex-col! items-center! justify-start gap-4">
          ...
          <div className="w-full h-full flex flex-col items-center justify-center gap-8">
            <button className="h-2/3 w-fit" onClick={() => setBiometrics(!biometrics)}>
              <IoFingerPrint className="w-auto h-full duration-300" style={{ opacity: biometrics ? "1" : "0.25", color: biometrics ? "var(--accent)" : "" }} />
            </button>
            <p className="duration-300" style={{ opacity: biometrics ? "1" : "0.5" }}>
              Biometrics has been{" "}
              <span className="font-semibold" style={{ opacity: biometrics ? "1" : "0.5", color: biometrics ? "var(--accent)" : "" }}>
      ...
      <footer className="w-full h-fit flex flex-row  items-center justify-center gap-4">
        <button
          className="bg-transparent w-2/5 h-fit flex items-center justify-center py-4 px-8 rounded-full"
          onClick={() => {
            swiper?.slidePrev();
          }}
        >
        ...
        <button
          className="bg-(--accent) w-full h-fit flex items-center justify-center p-4 rounded-full"
          onClick={() => {
            swiper?.slideNext();
          }}
        >
